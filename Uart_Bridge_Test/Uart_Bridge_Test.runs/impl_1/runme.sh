...
HD_PWD='C:/Users/admin/Desktop/uart_bridge_test/Uart_Bridge_Test/Uart_Bridge_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uart8.tcl -notrace
