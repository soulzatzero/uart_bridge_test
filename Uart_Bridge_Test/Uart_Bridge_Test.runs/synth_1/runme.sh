...
HD_PWD='C:/Users/admin/Desktop/uart_bridge_test/Uart_Bridge_Test/Uart_Bridge_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart8.tcl
