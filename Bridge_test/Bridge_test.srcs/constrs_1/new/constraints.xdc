...
create_clock -period 5.000 -name clk_in1_n -waveform {0.000 2.500} -add
create_clock -period 5.000 -name clk_in1_p -waveform {2.500 5.000} -add
...
set_property IOSTANDARD LVCMOS18 [get_ports rxBusy]
set_property IOSTANDARD LVCMOS33 [get_ports rxDone]
set_property IOSTANDARD LVCMOS18 [get_ports rxErr]
set_property IOSTANDARD LVCMOS18 [get_ports txBusy]
set_property IOSTANDARD LVCMOS18 [get_ports txDone]


set_property PACKAGE_PIN W24 [get_ports txInLow]
set_property IOSTANDARD LVCMOS33 [get_ports txInLow]
